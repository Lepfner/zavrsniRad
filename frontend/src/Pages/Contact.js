  ...
  return (
    <>
      <div className="font-custom w-full flex justify-center items-center mt-10">
        <div className="w-3/4 p-3 rounded-2xl text-center flex items-center space-x-4 shadow-2xl flex-col md:flex-row">
          ...
          <div className="sm:m-10 m-0 sm:w-2/3 w-full flex flex-col justify-center text-center">
            <div className="text-3xl mt-10 sm:mt-0">ABOUT US:</div>
            <div className="text-lg text-justify ml-0 mr-0 sm:ml-20 sm:mr-20 mt-10">
              ...
              looking to explore new bike routes and discover hidden gems
              in their area. With user-friendly features and intuitive
              navigation, our app makes it easy to plan your next cycling
              adventure. With our online bicycle route app, you'll never
              run out of exciting new routes to explore. We hope you have a
              wonderful time using our website and be sure
              to let us know if there are any problems or if something/someone
              is bothering you.
              Our team is working around the clock to make sure your experience
              is smooth as possible.
              You can contact us using email or using the website's report
              system.
            </div>
